...
- [ ] Open a BPI MySaveUp through GCash instead — SaveUp is closed to Aki for good. It is new-to-bank only, and BPI counts anyone whose account the bank closed as a Returning Client, so there is no waiting period to sit out. MySaveUp takes existing and returning clients, same Php 1 opening and Php 0 ADB, and needs a fully verified GCash. Fund it the day it opens #finances !med
