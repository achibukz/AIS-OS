...
| 6 | Project / task tracking | Canvas LMS (school tasks) + achiMem (general — proposed) + achiOS (this repo, project specs) | Canvas client/cache source on ticket/26-canvas-data-notifications; no scheduled integration deployed. Live probe returned expired authentication. | private Ubuntu cookie jar under ~/.config/achios/canvas | 2026-09-08 |
