...
| 6 | Project / task tracking | Canvas LMS (school tasks) + achiMem (general — proposed) + achiOS (this repo, project specs) | Canvas client/cache merged in PR #33; existing session probe valid on 2026-09-09. Temporary phone-login gateway in progress under #27; live phone acceptance and scheduled integration remain pending. | private Ubuntu cookie jar under ~/.config/achios/canvas | 2026-09-08 |
