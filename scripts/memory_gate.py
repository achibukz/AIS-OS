...
the native agy CLI with an enforced JSON schema. Any attempted tool call voids
the answer. This module performs no writes. The caller owns any state change.
...
def _default_runner(prompt: str) -> str:
    ...
    structured = agy_classify.classify(prompt, schema)
